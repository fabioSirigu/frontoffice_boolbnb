        ...
        <div class="homes_wrapper">
          <div class="homes_elements vh-100">
            ...
            <div v-else-if="functionActive">
              <div v-if="filteredRoomServicesHomes.length > 0">
                <div class="titles_elements text-center">
                  ...
                  <div class="home_results_elements container">
                    <div class="row align-items-center align-content-start g-4">
                      <HomeCard v-for="home in filteredRoomServicesHomes" :home="home" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div v-else>
              ...
              <div class="home_results_elements container">
                <div class="row align-items-center align-content-start g-4">
                  <HomeCard v-for="home in filteredHomes" :home="home" />
                </div>
              </div>
            </div>
          </div>
